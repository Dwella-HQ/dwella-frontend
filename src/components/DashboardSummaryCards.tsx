      ...
      {cards.map((card, index) => {
        ...
        return (
          <motion.div
            ...
            className="rounded-lg border border-gray-200 bg-white p-3 sm:p-5 shadow-sm overflow-hidden"
          >
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="rounded-lg bg-blue-50 p-1.5 sm:p-2 flex-shrink-0">
                <Icon className="h-4 w-4 sm:h-5 sm:w-5 text-brand-main" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">
                  {card.title}
                </p>
                <p className="mt-1 sm:mt-2 text-xl sm:text-3xl font-bold text-gray-900 break-words leading-tight">
                  {card.value}
                </p>
