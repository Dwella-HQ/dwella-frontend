    ...
    <>
      ...
      <div className="mx-auto w-full max-w-4xl">
        ...
        <button
          type="button"
          onClick={() =>
            showToast("Google sign-up for guests is coming soon.", "info")
          }
          className="mt-4 flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white text-sm font-medium text-gray-800 transition hover:bg-gray-50"
        >
          <GoogleGlyph />
          Sign Up with Google
        </button>
