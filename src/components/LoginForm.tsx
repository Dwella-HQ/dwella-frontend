    ...
    <div className="w-full max-w-md mx-auto">
      <form onSubmit={handleFormSubmit} className="flex flex-col gap-6">
        ...
        <button
          ...
          disabled={loading}
          className="flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white text-sm font-medium text-gray-800 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-70"
        >
          <GoogleGlyph />
          Sign in with Google
        </button>
