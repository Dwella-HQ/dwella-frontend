    ...
    <>
      ...
      <section className="space-y-6">
        ...
        <motion.div
          ...
          className="rounded-lg bg-brand-main p-6 sm:p-8 text-white shadow-lg"
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <Building2 className="h-12 w-12 sm:h-16 sm:w-16 text-white/20" />
          </div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-6 shadow-sm">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <button
              type="button"
              onClick={() => router.back()}
              className="flex-1 sm:flex-initial px-6 py-3 rounded-lg border border-gray-300 bg-white text-sm sm:text-base font-medium text-gray-700 hover:bg-gray-50 transition"
            >
              Cancel
            </button>
            <motion.button
              ...
              className="flex-1 sm:flex-initial px-6 py-3 rounded-lg bg-brand-main text-sm sm:text-base font-medium text-white hover:bg-brand-main/90 transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isProcessing ? (
                <>
                  <svg
